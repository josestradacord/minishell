...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/09/11 17:05:44 by gpaez-ga          #+#    #+#              #
#    Updated: 2023/10/20 20:03:34 by gpaez-ga         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
get_next_line.c ft_putnbr.c ft_putnbr_hexa.c ft_putnbr_u.c ft_putchar.c\
ft_putstr.c ft_putpointer.c ft_printf.c
